...
<html>
	<head>
		...
		<meta
			name="description"
			content="Coming Soon CoolApi"
		/>
		<meta
			name="keywords"
			content="coolapi, coming, soon, laravel, api"
		/>
		<title>Coming Soon - Cool Api</title>
	...
	<body>
		<section class="hero is-fullheight">
			...
			<div class="hero-foot">
				<div class="container has-text-centered">
					<p class="footer-text">
						<a href="https://www.americavirtual.net"
							>Designed with
							<i class="fa fa-heart fa-fw heart"></i>
							by America Virtual</a
						>
					</p>
				</div>
			</div>
